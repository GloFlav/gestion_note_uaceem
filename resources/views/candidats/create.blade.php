...
"
        ...
        <div class="max-w-5xl px-1 py-1 sm:px-6 lg:px-1 lg:py-0 mx-auto">
            ...
            <div class="bg-gray-100 rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-900">
                <div class="text-center mb-8">
                    ...
                    <label for="af-payment-billing-contact" class="inline-block text-lg font-high dark:text-white">
                        L'inscription pour le concours d'entrer à l'Université ACEEM se débute le
                        <strong>{{ $deb_insc }}</strong> et se termine le <strong>{{ $fin_insc }}</strong> pour la
                        <strong>{{ $vague_designation }}</strong>. <br>
                ...
                <form method="POST" action="{{ route('candidats.enregistre') }}">
                    ...
                    <!-- Section -->
                    <div
                        class="py-2 first:pt-1 last:pb-1 border-t first:border-transparent border-gray-400 dark:border-neutral-700 dark:first:border-transparent">
            ...
            shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Nom complet" name="nom" value="{{ old('nom') }}">
                            @error('nom')
                ...
                @enderror
                shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                    placeholder="Numéro du Bacc" name="num_bacc" value="{{ old('num_bacc') }}">

                                <input type="number" min="1990" max="2500" step="1" value="2024"
                                    class="py-2 px-3 pe-11 block w-full border-gray-400 border
                @error('anne_bacc')
                  border-red-500
                @enderror
            ...
            @enderror
            shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="0340000000" name="tel" value="{{ old('tel') }}">
                            @error('tel')
                                <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">{{ $message }}
                                </p>
                            @enderror
              ...
              @enderror
              shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="aceem@gmail.com" name="email" value="{{ old('email') }}">
                            @error('email')
                                <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">{{ $message }}
                                </p>
                            @enderror
              ...
              @enderror
              shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="123456789" name="ref_mvola" value="{{ old('ref_mvola') }}">
                            @error('ref_mvola')
                                <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">{{ $message }}
                                </p>
                            @enderror
