    ...
    <div class="max-w-2xl px-0 py-2 sm:px-0 lg:px-0 lg:py-0 mx-auto">
        ...
        <form>
            ...
            <div class="mt-5 flex justify-center gap-x-2">
                <a href="{{ route('inscription.index')}}" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
                  Retour
                </a>
            </div>
        </form>
