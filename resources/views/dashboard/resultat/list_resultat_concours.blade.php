                        ...
                        <div class="py-4 grid gap-3 md:flex flex-col  border-b border-gray-200 dark:border-neutral-700">
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between gap-x-8 gap-y-4">
                                <form method="GET" class="flex gap-5" id="search-form">
                                        ...
                                        <div class="relative">
                                            ...
                                            @if ($key != '')
                                                <div class=" absolute inset-y-0 end-0 flex items-center z-20 pe-1">
                                                    <a href="{{ route('dashboard.resultat.index.concours', ['id' => $id]) }}"
                                                        id="reset-search"
                                    ...
                                    <!-- End Search Input -->
                                    @php
                                        $candidat_filters = session('candidat_concours_filters', [
                                            'all' => true,
                                            'admis' => true,
                                            'recale' => true,
                                            'pending' => true,
                                ...
                                <div class="flex gap-4">
                                    <form method="POST" id="file-upload-form"
                                        action="{{ route('dashboard.resultat.import') }}" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <a href="{{ route('dashboard.resultat.export', ['id' => $id]) }}"
                                    ...
                                    @if ($is_published)
                                        <form method="POST"
                                            action="{{ route('dashboard.resultat.unpublish', ['id' => $id]) }}">
                                            @csrf
                                    ...
                                    @else
                                        <form method="POST"
                                            action="{{ route('dashboard.resultat.publish', ['id' => $id]) }}">
                                            @csrf
                                            <input type="text" class="hidden" value="{{ $id }}"
                                                name="vagues_id">
                                            <button type="submit"
