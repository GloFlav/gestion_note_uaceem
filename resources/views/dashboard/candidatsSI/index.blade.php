                        ...
                        <div class="py-4 grid gap-3 md:flex flex-col  border-b border-gray-200 dark:border-neutral-700">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    Gérez les Candidats en ajoutant de nouveaux membres, <br> en modifiant les
                                    informations
                            ...
                            <div class="flex flex-col sm:flex-row gap-x-8 gap-y-4">
                                <div class="inline-flex gap-x-2">
                                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                                        href="{{ route('dashboard.candidatsSI.createSI') }}">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                @foreach ($candidats as $candidat)
                                    <tr>
                                        ...
                                        <td class="h-px whitespace-nowrap px-6">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500 capitalize">
                                                {{ $candidat->mode_inscription === 'en_ligne' ? 'en ligne' : 'en local' }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-4 py-3">
                                                <span
                                                    class="text-sm text-gray-500 dark:text-neutral-500">{{ $candidat->created_at->format('d M, H:i') }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-1 py-1.5">
                                                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                                                    href="{{ route('dashboard.candidatsSI.showSI', ['id' => $candidat->id]) }}">
                                                    Voir
                                                </a>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-1 py-1.5">
                                                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                                                    href="{{ route('dashboard.candidatsSI.edit', ['id' => $candidat->id]) }}">
                                                    Editer
                                                </a>
                                            </div>
                                        </td>
            ...
            <div
                ...
                <div class="p-4 overflow-y-auto">
                    <p class="mt-1 text-gray-800 dark:text-neutral-400">
                        Êtes-vous sûr de vouloir supprimer cet candidat ?
                    </p>
                </div>
