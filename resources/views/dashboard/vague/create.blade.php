...
@section('content')
    ...
    <div class=" px-1 py-1 sm:px-6 lg:px-1 mx-auto"><!-- Card -->
        <div class=" p-4 sm:p-1 ">
            ...
            <form method="POST" action="{{ route('dashboard.vague.vague.store')}}">
                @csrf
                <div class="space-y-2">
                    <label for="type"
                    ...
                    <div class="mt-2 space-y-3">
                        <div class="flex flex-col sm:flex-row gap-3">
                            <input id="deb_co" type="date"
                                ...
                                dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" name="deb_insc[]" >
                            <input type="date"
                                ...
                                dark:focus:ring-neutral-600" name="fin_insc[]" id="fin_insc">
                        </div>
                        <div class="gap-0">
                            @error('deb_insc')
                                <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">
                    ...
                    <div class="mt-2 space-y-3">
                        <div class="flex flex-col sm:flex-row gap-3">
                            <input type="date"
                                ...
                                @enderror
                                shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900
                                dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" name="deb_conc[]" id="deb_conc">
                            <input id="date" type="date"
                                class="py-2 px-3 pe-11 block w-full border border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500
                                disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500
                                dark:focus:ring-neutral-600" name="fin_conc[]" id="fin_conc">
                        </div>
                        <div class="gap-0">
                            @error('deb_conc')
                                <p class="text-sm text-red-600 mt-2" id="hs-validation-name-error-helper">
