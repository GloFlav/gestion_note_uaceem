...
@section('content')
 ...
 <div class=" px-1 py-1 sm:px-6 lg:px-1 mx-auto"><!-- Card -->
    <div class=" p-4 sm:p-1 ">
        ...
        <form method="POST" action="{{ route('dashboard.payement.payement.enligne.update', $candidats->payement->id) }}">
            @csrf
            @method('PUT')
        ...
        <!-- End Section -->
         ...
         <div class="py-2">
          ...
          <div class="mt-5 flex justify-end gap-x-2">
            ...
            href="{{ route('dashboard.payement.payement.enligne.affiche', $candidats->id) }}">
            Annuler
            </a>
