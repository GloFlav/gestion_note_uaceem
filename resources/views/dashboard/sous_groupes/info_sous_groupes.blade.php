        ...
        <div class=" p-4 sm:p-1 ">
            <div class="mb-4">
                <h2 class="text-2xl mb-4 font-bold text-gray-800 dark:text-neutral-200">
                    Information sous-groupes
                </h2>
                <p class="text-sm text-gray-600 dark:text-neutral-400">
                    Voici les informations sur le sous-groupe.
            ...
            <div>
                ...
                <div class="space-y-2 space-x-3">
                    ...
                    @if($sousgroupes->groupe)
                    <span class="text-gray-600">
                        {{ $sousgroupes->groupe->design}}
                    </span>
                    @else
                    <span class="text-gray-600">
                        Le groupe approprié n'est pas trouvé.
                    </span>
                    @endif
                </div>
            ...
            <div class="mt-4">
                ...
                <div class="inline-flex gap-x-2">
                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                        href="{{ route('dashboard.academique.sousgroupe.edit', ['id' => $sousgroupes->id]) }}">
                        Modifier
                    </a>
                </div>
            </div>
